...
--------------------------------------------------
\x1b[1;97m[+] 𝗔𝗨𝗧𝗛𝗢𝗥  :   MR AUH NAME TO SUNA HO GA

\x1b[1;97m[+] 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞:   AHSAM UL HAQ

\x1b[1;97m[+] 𝗚𝗜𝗧𝗛𝗨𝗕  :   https://github.com/MR-AUH404

\x1b[1;97m[+] WHATSAPP:  +93411471937

\x1b[1;97m[+] 𝗧𝗘𝗔𝗠    :   \33[1;42  AUH-TEAM-HACK\33[0m
...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> AUH/BRAND TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[AUH / BRAND] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[AUH / BRAND] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mAUH / BRAND\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
